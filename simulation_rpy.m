 function simulation_rpy_3dmath
clear;
...
% ===== Physical Properties ==========
    ...
    %  === Copter Properties ======
        ...
        thrust2torque = @(cmds) [1 0 0 0; 2/3 0 0 1/3; -1/3 0 0 -2/3; 0 0 0 -1]*cmds; % Function mapping 8-bit ESC input to generated motor torque [N*m]  
...
% ===== Simulation Setup ==========
    ...
    %  === Initial Conditions Setup ======
        ...
        Told = 0;
        motor_thrusts = zeros(4,1); % Define initial thrusts and torques

        ICs = [ % Define initial kinematic conditions
            0 0 0 0 0 1; % pry xyz position
